...
<code>-T4</code> is a balanced timing profile. It’s quicker than defaults, but less likely to overwhelm fragile services or trigger rate‑limit alarms compared to -T5. This is useful when you need reasonable speed on approved testing windows while still being considerate of target stability.
